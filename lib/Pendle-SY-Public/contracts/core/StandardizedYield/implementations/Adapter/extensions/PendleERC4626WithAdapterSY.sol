...
contract PendleERC4626WithAdapterSY is SYBaseUpg, MerklRewardAbstract__NoStorage, IPStandardizedYieldWithAdapter {
    ...
    function _previewRedeem(
        ...
        if (tokenOut == yieldToken) {
            ...
            if (tokenOut != asset) {
                return IStandardizedYieldAdapter(adapter).previewConvertToRedeem(tokenOut, amtAsset);
            } else {
                return amtAsset;
            }
        }
